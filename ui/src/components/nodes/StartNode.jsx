  ...
  return (
    <div
      style={{
        ...
        minWidth: '220px',
        boxShadow:
          '0 8px 24px rgba(139, 92, 246, 0.3), 0 4px 12px rgba(0, 0, 0, 0.1), inset 0 1px 0 rgba(255, 255, 255, 0.2)',
      ...
      onMouseEnter={e => {
        e.currentTarget.style.boxShadow =
          '0 12px 32px rgba(139, 92, 246, 0.4), 0 6px 16px rgba(0, 0, 0, 0.15), inset 0 1px 0 rgba(255, 255, 255, 0.3)';
      }}
      onMouseLeave={e => {
        e.currentTarget.style.boxShadow =
          '0 8px 24px rgba(139, 92, 246, 0.3), 0 4px 12px rgba(0, 0, 0, 0.1), inset 0 1px 0 rgba(255, 255, 255, 0.2)';
